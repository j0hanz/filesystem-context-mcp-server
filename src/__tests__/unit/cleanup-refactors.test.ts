...
describe('Cleanup Refactors', () => {
  ...
  it('for...of preserves iteration and side effects', () => {
    ...
    assert.deepEqual(mapResults1, mapResults2, 'for...of and forEach should mutate maps identically');
  ...
  it('delete operator removes properties same as Reflect.deleteProperty', () => {
    ...
    assert.deepEqual(obj1, obj2, 'delete and Reflect.deleteProperty should produce identical results');
